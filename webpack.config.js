...
module.exports = env => {
  ...
  const config = {
    ...
    module: {
      rules: [
...

        {
          ...
          use: ["nativescript-dev-webpack/moduleid-compat-loader", "nativescript-dev-webpack/lazy-ngmodule-hot-loader", "@ngtools/webpack"]
        },
    ...
    plugins: [
      ...
      new CopyWebpackPlugin(
        [{ from: { glob: "fonts/**" } }, { from: { glob: "images/**" } }, { from: { glob: "**/*.jpg" } }, { from: { glob: "**/*.png" } }],
